...
Chefes progressivos mantêm limites explícitos na configuração: vida cresce de 3 até 5 corações, o intervalo de tiro cai em passos de 0,3 segundo de 1,8 até 0,6 segundo e jamais chega a zero. A escala visual depende da vida corrente, não apenas da aparição, de modo que cada impacto comunica redução de resistência. Velocidade de patrulha usa `vidaMaxima - vida`, evitando fórmulas incorretas quando a vida inicial supera três. Fantasmas de chefe são agendados, não criados antecipadamente: após dez segundos com o chefe vivo, duas entidades nascem nas bordas opostas da arena, perseguem o jogador e cada contato abre um desafio difícil.
